...
import net.kaleidos.tuesmon.builder.IssueBuilder
import net.kaleidos.tuesmon.builder.MilestoneBuilder
import net.kaleidos.tuesmon.builder.ProjectBuilder
import net.kaleidos.tuesmon.builder.TaskBuilder
import net.kaleidos.tuesmon.builder.UserStoryBuilder
import net.kaleidos.tuesmon.builder.WikilinkBuilder
import net.kaleidos.tuesmon.builder.WikipageBuilder
import net.kaleidos.tuesmon.mapper.Mappers

@Log4j
class TuesmonClient extends BaseClient {
    ...
    TuesmonClient(String serverUrl) {
        super(serverUrl)
    }

    TuesmonClient authenticate(String username, String password) {
