...
class UserStoryTuesmonSpec extends TuesmonSpecBase {
    ...
    void 'create a user story with ref = #ref'() {
        ...
        when: 'creating the user story'
            userStory = tuesmonClient.createUserStory(userStory)

        then: 'the user story is created in Tuesmon'
            userStory != null
            userStory.ref == (ref ?: 1)
    ...
    void 'create a user story with owner, created date and finished date'() {
        ...
        then: 'the issue is created in Tuesmon with the optional fields'
            userStory != null
    ...
    void 'create a user story with two attachments'() {
        ...
        then: 'the user story is created in Tuesmon with the attachments'
            userStory != null
    ...
    void 'create a user story with tags'() {
        ...
        then: 'the issue is created in Tuesmon with the tags'
            userStory != null
            userStory.tags == tags
