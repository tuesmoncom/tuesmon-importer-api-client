...
class TaskTuesmonSpec extends TuesmonSpecBase {
    ...
    void 'create a new task with ref = #ref'() {
        ...
        when: 'creating the task'
            task = tuesmonClient.createTask(task)

        then: 'the task is created in Tuesmon'
            task != null
            task.ref == (ref ?: 1)
    ...
    void 'create a task related to a user story'() {
        given: 'a user story'
            ...
            us = tuesmonClient.createUserStory(us)
    ...
    void 'create a task with owner, created date and finished date'() {
        ...
        then: 'the task is created in Tuesmon with the optional fields'
            task != null
            task.owner == owner
    ...
    void 'create a task with two attachments'() {
        ...
        then: 'the task is created in Tuesmon with the attachments'
            task != null
    ...
    void 'create a task with tags'() {
        ...
        then: 'the task is created in Tuesmon with the tags'
            task != null
            task.tags == tags
