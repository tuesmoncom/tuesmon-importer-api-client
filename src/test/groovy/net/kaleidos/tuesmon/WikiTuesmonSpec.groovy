...
class WikiTuesmonSpec extends TuesmonSpecBase {
    ...
    void 'create a wiki page and let Tuesmon convert the name to slug'() {
        given: 'a wiki page to save'
            def wikipage = new Wikipage()
                .setProject(project)
                .setSlug(slug)
    ...
    void 'create a wiki link'() {
        ...
        when: 'saving the wiki link'
            wikilink = tuesmonClient.createWikiLink(wikilink)
